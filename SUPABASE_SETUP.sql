-- SUPABASE_SETUP.sql
-- Run this SQL in your Supabase Database SQL Editor to configure tables, storage, triggers, seed data, and administrative access.
...
-- ===================================================
-- 7. STORAGE BUCKET & RLS POLICIES Setup
-- ===================================================
...
-- ===================================================
-- 8. PROMOTING A USER TO ADMINISTRATOR
-- ===================================================
-- Once you have registered an account on the customer storefront with your phone number,
-- uncomment the lines below, replace 'YOUR_PHONE_NUMBER' with your number (e.g. '7892510154'),
-- and execute this query to grant owner dashboard access:
--
